...
import sidemap from "../../assets/worker4.jpg";
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/worker/register`,
        worker
      );
      ...
      <div className="p-10 flex flex-col justify-start items-start gap-8 lg:w-1/2 bg-white rounded-lg">
        ...
        <div className="flex flex-col gap-2">
          <h1 className="font-bold text-2xl lg:text-3xl">
            Get started with your worker account today.
          </h1>
        ...
        <form className="w-full flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <p className="text-md font-medium">
              Service Type*
              <span className="text-gray-400 font-light italic px-2">

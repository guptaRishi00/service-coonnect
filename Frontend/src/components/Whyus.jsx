...
function WhyUs() {
  return (
    <div className="flex gap-40 justify-center w-full items-center py-20">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative bg-gray-200 h-[550px] w-[45%] overflow-hidden rounded-lg"
      >
      ...
      >
        ...
        <motion.h1
          ...
          viewport={{ once: true }}
          className="font-bold text-5xl flex flex-col items-start gap-4"
        >
          The Advantage:
        ...
        <motion.button
          ...
          viewport={{ once: true }}
          className="px-5 py-4 bg-[#FE8058] font-medium text-white rounded-lg flex items-center"
        >
          Book Now
